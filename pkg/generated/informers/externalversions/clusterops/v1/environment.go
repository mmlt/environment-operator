...
import (
	...
	versioned "github.com/mmlt/environment-operator/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/mmlt/environment-operator/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/mmlt/environment-operator/pkg/generated/listers/clusterops/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusteropsV1().Environments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusteropsV1().Environments(namespace).Watch(context.TODO(), options)
			},
		},
		&clusteropsv1.Environment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *environmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusteropsv1.Environment{}, f.defaultInformer)
}
