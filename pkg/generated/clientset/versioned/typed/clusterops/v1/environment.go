...
import (
	...
	scheme "github.com/mmlt/environment-operator/pkg/generated/clientset/versioned/scheme"
...
func newEnvironments(c *ClusteropsV1Client, namespace string) *environments {
	return &environments{
		client: c.RESTClient(),
		ns:     namespace,
	}
